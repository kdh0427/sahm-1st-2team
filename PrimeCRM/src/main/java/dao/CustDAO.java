	...
	public String getList() throws NamingException, SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				first = false;
				str.append("{").append("\"id\": \"").append(rs.getString("Cust_ID")).append("\", ")
						.append("\"name\": \"").append(rs.getString("NAME")).append("\", ").append("\"bday\": \"")
						.append(rs.getString("BDAY")).append("\", ").append("\"email\": \"")
						.append(rs.getString("EMAIL")).append("\", ").append("\"udate\": \"")
						.append(rs.getString("UDATE")).append("\", ").append("\"address\": \"")
						.append(rs.getString("ADDRESS")).append("\", ").append("\"phone\": \"")
						.append(rs.getString("NUM")).append("\", ").append("\"type\": \"").append(rs.getString("TYPE"))
						.append("\", ").append("\"status\": \"").append(rs.getString("Cust_status")).append("\" ")
						.append("}");
			}
			return str.append("]}").toString();
	...
	public String getCTList() throws NamingException, SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				str.append("{ \"basis\": \"").append(basis).append("\", \"percentage\": \"").append(percentage)
						.append("\" }");
			}
			return str.append("],").toString();
		} finally {
	...
	public String getMyCust(String email) throws NamingException, SQLException {
		...
		try {
			...
			while (rs.next()) {
				...
				first = false;
				str.append("{").append("\"name\": \"").append(rs.getString("NAME")).append("\", ")
						...
						.append("\"cust_status\": \"").append(rs.getString("CUST_STATUS")).append("\"").append("}");
			}
			str.append("]}"); // JSON 닫기
			return str.toString();
		} finally {
